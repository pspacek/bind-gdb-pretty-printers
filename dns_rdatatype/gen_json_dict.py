...
/*
 this program generates JSON dict with numberic values for all rdatatype #defines
  {"1": "dns_rdatatype_a"}
*/
int                                                                             
...
"""
    ...
    prefix = ""
    for l in defines:
        match = re.match("^#define +(dns_rdatatype_[a-zA-Z]+) ", l)
        if match:
